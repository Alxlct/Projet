...
<body>
    <header>
        ...
        <h1 class="text-center m-5">Conditions Générales d'Utilisation</h1>
    </header>


    <div class="row d-flex justify-content-evenly p-0 m-0">
        <div class="col-lg-10 bg-light">
            <div class="row d-flex justify-content-evenly my-2 p-0 m-0">
                <div class="col-lg-8 bg-light my-3">
                    ...
                    <div>
                        ...
                        <p>Pour plus d'informations sur les cookies que nous utilisons et sur vos choix en matière de cookies, veuillez consulter notre Politique en matière de cookies ou la section Cookies de notre Politique de confidentialité.</p>
                        <p>.
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>Gérer vos demandes :</strong> Assister et gérer les demandes que vous nous adressez.</p>
                            </li>
                            <li>
                                </p><strong>Pour les transferts d'entreprise:</strong>Nous pouvons utiliser Vos informations pour évaluer ou réaliser une fusion, une cession, une restructuration, une réorganisation, une dissolution ou toute autre vente ou transfert de tout ou partie de Nos actifs, que ce soit dans le cadre d'une poursuite d'activité ou d'une faillite, d'une liquidation ou d'une procédure similaire, dans laquelle les Données personnelles que Nous détenons sur les utilisateurs de nos Services font partie des actifs transférés.</p>
                                <p>
                            </li>
                            <li>
